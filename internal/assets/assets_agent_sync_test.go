...
// internal/assets/genagent and compares bytes; -trimpath (see genagent)
// is what makes this reproducible across machines/checkouts. Run `go
// generate ./internal/assets` and commit the result if this fails.
